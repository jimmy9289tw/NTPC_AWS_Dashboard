/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts --config wrangler.production.jsonc` (hash: 96aaae803ddfd571384c7f798a75d35c)
...
interface __BaseEnv_Env {
	...
	GOOGLE_CLIENT_ID: "307075294079-h3778np1vdttcivoams8ri3p3t5l1be0.apps.googleusercontent.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "GOOGLE_CLIENT_ID" | "SESSION_COOKIE_NAME" | "SESSION_TTL_SECONDS">> {}
}
