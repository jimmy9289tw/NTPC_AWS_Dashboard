...
> 目前儀表板請先依 `pages/workspace-v532.md`。它是 G6 UI V5.32 的呈現規格，優先於本檔及 `pages/dashboard.md` 的歷史視覺規則；資料與政策規則不在此覆寫。
...
**Project:** NTPC Youth Evidence Console
**Generated:** 2026-08-15 23:11:39
